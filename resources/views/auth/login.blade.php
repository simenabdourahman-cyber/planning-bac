<x-guest-layout>
{{--
  MENFOP DJIBOUTI - Page de Connexion BAC 2025
...
/* ── BRANDING GAUCHE ── */
.branding{
    flex:1;max-width:400px;color:#fff;
...
.b-label{
    ...
    color:var(--or);font-weight:700;margin-bottom:14px;
}
.b-title{
...
.b-desc{
    ...
    line-height:1.75;max-width:330px;margin-bottom:36px;
}
.b-stats{display:flex;gap:28px;align-items:center;}
.bst{text-align:center;}
.bst-n{
    font-family:'Playfair Display',serif;
    font-size:30px;font-weight:900;color:var(--or);line-height:1;
}
...
.c-logo{
    ...
    display:flex;align-items:center;justify-content:center;
    margin:0 auto 14px;
    box-shadow:0 8px 24px rgba(26,58,108,.35);
    font-size:28px;
}
.c-title{
    font-family:'Playfair Display',serif;
    font-size:22px;font-weight:800;color:var(--bleu);margin-bottom:4px;
}
...
.r-lbl{
    ...
    text-transform:uppercase;color:#999;margin-bottom:10px;display:block;
}
...
.r-btn.on{
    border-color:var(--bleu);background:rgba(26,58,108,.07);
    box-shadow:0 0 0 3px rgba(26,58,108,.12);
}
...
.r-chk{
    ...
    background:var(--bleu);color:#fff;font-size:9px;
...
.cand-info{
    display:none;
    background:rgba(26,58,108,.06);
    border:1.5px solid rgba(26,58,108,.15);
    border-radius:10px;padding:12px 14px;
    font-size:12px;color:var(--bleu);
...
.pw-btn{
    ...
    color:#CCC;font-size:16px;padding:0;
    transition:color .2s;
}
...
.c-foot{
    ...
    font-size:10.5px;color:#CCC;line-height:1.8;
}
...
<div class="l-wrap">
    ...
    <div class="branding">
        ...
        <div class="b-stats">
            <div class="bst">
                <div class="bst-n">4 821</div>
                <div class="bst-l">Candidats</div>
            </div>
            <div class="bst-sep"></div>
            <div class="bst">
                <div class="bst-n">18</div>
                <div class="bst-l">Centres</div>
            </div>
            <div class="bst-sep"></div>
            <div class="bst">
                <div class="bst-n">10</div>
                <div class="bst-l">Établissements</div>
            </div>
            <div class="bst-sep"></div>
            <div class="bst">
                <div class="bst-n">4</div>
                <div class="bst-l">Séries</div>
            </div>
        </div>
    </div>
    ...
    <div class="l-card">
        ...
        <div class="c-foot">
            ...
            <span style="color:#DDD">© 2025 · Tous droits réservés</span>
        </div>
    </div>
...
var roles = {
    ...
    candidat:       {lbl:'NUMÉRO DE MATRICULE',  ico:'🪪', ph:'Ex: DJ-2025-0001', bIco:'👨‍🎓', bTxt:'Accéder à ma convocation'}
};
